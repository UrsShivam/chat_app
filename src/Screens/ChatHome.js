                ...
                if (props.currentUserId !== value.userId)
                    return (
                        <ListItem key={value.userId} disablePadding>
                            <ListItemButton
                                sx={{ backgroundColor: value.userId == receiverId ? '#F9F9F9' : '' }}
                                onClick={() => {
    ...
    return (
        <div style={root}>
            ...
            <Paper style={right}>
                        ...
                        allMessages.map(({ id, messages }) => {
                            return (
                                ...
                                >
                                    <span
                                        style={{
                                            backgroundColor: user?.uid == messages.messageUserId ? "#F4B302" : "#F9F9F9",
                                            padding: 6,
                                            borderTopLeftRadius:
                ...
                <div style={{ width: "100%", display: "flex", flex: 0.08, boxShadow: "0px 0px 10px rgba(1, 0, 0, 0.1)", pl: 3 }}>
                    <input
                        value={chatMessage}
